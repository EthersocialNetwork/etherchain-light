...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "/GoJS-1.8.26/assets/js/highlight",
      "jquery": "/GoJS-1.8.26/assets/js/jquery.min", // 1.11.3
      "bootstrap": "/GoJS-1.8.26/assets/js/bootstrap.min"
    },
    shim: {
      "bootstrap": ["jquery"]
    }
  ...
  function goLoadSrc(filenames) {
    ...
    for (i = 0; i < arguments.length; i++) {
      ...
      selt.async = false;
      selt.defer = false;
      selt.src = "/GoJS-1.8.26/assets/js/" + filename;
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/GoJS-1.8.26/assets/css/bootstrap.min.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/GoJS-1.8.26/assets/css/highlight.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/GoJS-1.8.26/assets/css/main.css";
head.appendChild(link);
...
function goSamples() {
  ...
  for (var i = 0; i < l; i++) {
    ...
    img.height = "200";
    img.src = "/GoJS-1.8.26/assets/images/screenshots/" + imgname + ".png";
...
//    <a href="/GoJS-1.8.26/api/symbols/TYPENAME.html">TYPENAME</a>
// and <a>TYPENAME.MEMBERNAME</a> with:
//    <a href="/GoJS-1.8.26/api/symbols/TYPENAME.html#MEMBERNAME">TYPENAME.MEMBERNAME</a>
function _traverseDOM(node) {
  if (node.nodeType === 1 && node.nodeName === "A" && !node.getAttribute("href")) {
    var text = node.innerHTML.split(".");
    if (text.length === 1) {
      node.setAttribute("href", "/GoJS-1.8.26/api/symbols/" + text[0] + ".html");
      node.setAttribute("target", "api");
    } else if (text.length === 2) {
      node.setAttribute("href", "/GoJS-1.8.26/api/symbols/" + text[0] + ".html" + "#" + text[1]);
      node.setAttribute("target", "api");
    } else {
    ...
    <div class="navbar navbar-default" role="navigation">\
      ...
      <div id="DiagramNavbar" class="navbar-collapse collapse sidebar-navbar-collapse">\
        <ul id="sections" class="classList nav navbar-nav">\
          ...
          <li><a href="/GoJS-1.8.26/extensions/Fishbone.html">GoJS Extensions</a></li>\
...
var myExtensionMenu = '\
  <div class="sidebar-nav">\
    <div class="navbar navbar-default" role="navigation">\
      ...
      <div id="DiagramNavbar" class="navbar-collapse collapse sidebar-navbar-collapse">\
        <ul id="sections" class="classList nav navbar-nav">\
          <li><a href="/GoJS-1.8.26/samples/index.html"><b>Index</b></a></li>\
          ...
          <li><a href="/GoJS-1.8.26/samples/flowchart.html">GoJS Samples</a></li>\
          <li><a href="/GoJS-1.8.26/samples/all.html">Complete List</a></li>\
        </ul>\
      </div>\
    </div>\
  </div>';
    ...
    <div class="container-fluid">\
      <div class="navbar-header">\
        <div class="navheader-container">\
          <div class="navheader-collapse" data-toggle="collapse" data-target="#navbar">\
            <a id="toplogo" class="navbar-brand" href="/GoJS-1.8.26/index.html">GoJS</a>\
      ...
      <div id="navbar" class="navbar-collapse collapse">\
        <ul class="nav navbar-nav navbar-right">\
          <li><a href="/GoJS-1.8.26/index.html">Home</a></li>\
          <li><a href="/GoJS-1.8.26/learn/index.html">Learn</a></li>\
          <li><a href="/GoJS-1.8.26/samples/index.html">Samples</a></li>\
          <li><a href="/GoJS-1.8.26/intro/index.html">Intro</a></li>\
          <li><a href="/GoJS-1.8.26/api/index.html" target="api">API</a></li>\
          <li><a href="https://www.nwoods.com/components/evalform.htm">Register</a></li>\
          <li><a href="/GoJS-1.8.26/download.html">Download</a></li>\
